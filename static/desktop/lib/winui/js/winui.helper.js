...
layui.define(['jquery', 'layer', 'winui'], function (exports) {
  ...
  var $ = layui.jquery
    //常量字符串
    , SETWIN = '.winui-helper-setwin', LOCK = '.winui-helper-lock', MENU = '.winui-helper-menu',
    SWITCH = '.winui-helper-switch', CONTENT = '.winui-helper-content', TOOL = '.winui-helper-tool'
    //16进制颜色校验表达式
