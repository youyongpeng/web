...
layui.define(['window', 'desktop', 'start', 'helper'], function (exports) {
  var $ = layui.jquery
  ...
  $(function () {
    ...
    winui.config({
      settings: layui.data('winui').settings || {
        ...
        taskbarMode: 'bottom',
        startSize: 'sm',
        bgSrc: '/static/desktop/images/bg_01.jpg',
        lockBgSrc: '/static/desktop/images/bg_04.jpg'
      }, // 如果本地配置为空则给默认值
      desktop: {
      ...
      menu: {
        options: {
          url: '/static/desktop/json/allmenu.json',
          method: 'get',
          data: { nihaoa: '' }
        },
